...
if(document.getElementById('btnRegistro')){
    ...
    btnRegistro.addEventListener('click',(e)=>{
        ...
        correo=formRegistro.email.value.trim();
        ...
        if(correo=="" && password==""){
            ...
            inputError([formRegistro.email,formRegistro.password]);
            return false;

        }else{
            //removemos esa clase con la siguente funcion
            //inputErrorRemove([formRegistro.nombre,formRegistro.correo,
            inputErrorRemove([formRegistro.email,formRegistro.password]);
        }
